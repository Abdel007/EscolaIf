...
public class VendaDAO{
   ...
   public List<Venda> listar() {
      return em.createNamedQuery("Venda.findAll").getResultList();
   }
   
   public List<Venda> listar(String filtro) throws Exception{
        return em.createNamedQuery("Venda.findFilter").setParameter("filtro","%" + filtro.toUpperCase() + "%").getResultList();
    }
